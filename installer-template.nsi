...
Function RunMainBinary
  ; Tauri's helper is the normal user-session launch route. With EnableLUA=0,
  ; hand the checked finish-page launch to Windows ShellExecute instead.
  ; This avoids inheriting the installer's administrative context.
  ClearErrors
