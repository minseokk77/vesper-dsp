...
#define MICARRAY_MIN_BITS_PER_SAMPLE            32      // Min bits per sample
...
#define VESPER_MICARRAY_PCM_FORMAT(sampleRate) \
    { \
        { \
...
{
    VESPER_MICARRAY_PCM_FORMAT(44100),
    VESPER_MICARRAY_PCM_FORMAT(48000),
    VESPER_MICARRAY_PCM_FORMAT(88200),
    VESPER_MICARRAY_PCM_FORMAT(96000),
    VESPER_MICARRAY_PCM_FORMAT(176400),
    VESPER_MICARRAY_PCM_FORMAT(192000),
    VESPER_MICARRAY_PCM_FORMAT(352800),
    VESPER_MICARRAY_PCM_FORMAT(384000)
};

#undef VESPER_MICARRAY_PCM_FORMAT
