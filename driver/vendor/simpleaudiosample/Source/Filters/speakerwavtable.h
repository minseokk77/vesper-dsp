...
#define VESPER_SPEAKER_PCM_FORMAT(sampleRate) \
    { \
        { \
...
{
    VESPER_SPEAKER_PCM_FORMAT(44100),
    VESPER_SPEAKER_PCM_FORMAT(48000),
    VESPER_SPEAKER_PCM_FORMAT(88200),
    VESPER_SPEAKER_PCM_FORMAT(96000),
    VESPER_SPEAKER_PCM_FORMAT(176400),
    VESPER_SPEAKER_PCM_FORMAT(192000),
    VESPER_SPEAKER_PCM_FORMAT(352800),
    VESPER_SPEAKER_PCM_FORMAT(384000)
};

#undef VESPER_SPEAKER_PCM_FORMAT
...
{
    {
        ...
        &SpeakerHostPinSupportedDeviceFormats[3].DataFormat  // 96KHz
    }
};
